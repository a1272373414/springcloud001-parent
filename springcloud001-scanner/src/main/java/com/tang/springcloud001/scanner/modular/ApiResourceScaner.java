package com.tang.springcloud001.scanner.modular;

import com.tang.springcloud001.api.auth.ResourceDefinition;
...
import com.tang.springcloud001.scanner.modular.util.AopTargetUtils;
import com.tang.springcloud001.scanner.modular.annotation.GetResource;
import com.tang.springcloud001.scanner.modular.annotation.PostResource;
import com.tang.springcloud001.scanner.modular.factory.ApiResourceFactory;
import com.tang.springcloud001.scanner.modular.stereotype.ApiResource;
...
/**
 * 资源扫描器
 * BeanPostProcessor 一般用于对同容器的bean在初始化前后进行重新封装
 * @author fengshuonan
